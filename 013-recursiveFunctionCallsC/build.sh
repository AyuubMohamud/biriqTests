...
riscv32-unknown-elf-gcc -T link.ld -o test013.elf -ffreestanding -nostdlib -march=rv32imc_zcb_zba_zbb_zbs_zicond_zicsr_zifencei -Oz main.o start.o
riscv32-unknown-elf-objdump -d test013.elf >> dump.txt
riscv32-unknown-elf-objcopy -O verilog --verilog-data-width=4 test013.elf test.mem
rm -rf *.o
rm -rf *.elf